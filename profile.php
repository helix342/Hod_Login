  ...
  <head>
    ...
    <style>
      body {
        ...
        background-color: #e4e4e4; /* Same as container background */
        margin: 0;
        padding: 0;
      }
            ...
            <ul id="sidebarnav" class="p-t-30">
              ...
              <li class="sidebar-item">
                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://www.camsmkce.in" aria-expanded="false">
                  ...
                  <span class="hide-menu">CAMS</span>
                </a>
              </li>
            </ul>
          </nav>
      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid profile-container mt-4">
          <div class="profile-header">
            <img src="assets/images/users/mkce_1.jpg" alt="Profile Image">
            <div>
              <h4>Head</h4>
              <p class="text-secondary">Head of the department</p>
              <p class="text-muted">Department of Artificial Intelligence and Machine Learning</p>
            </div>
          </div>
